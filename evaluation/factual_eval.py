...
data_path = f"../gen_code/gen_results/test_data/{model}/{name}.json"
...
def process_item(item):
    ...
    is_correct = any(answers_match(model_answer, ans) for ans in final_answer)
