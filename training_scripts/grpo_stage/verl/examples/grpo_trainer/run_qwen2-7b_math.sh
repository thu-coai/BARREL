<<<<<<< HEAD:examples/ppo_trainer/run_qwen2-7b.sh
...
>>>>>>> 4081d8af1f4c6cbfcf2b27c2556da3345ec9d826:examples/grpo_trainer/run_qwen2-7b_math.sh
...
<<<<<<< HEAD:examples/ppo_trainer/run_qwen2-7b.sh
    ...
    trainer.total_epochs=3 | tee verl_demo.log
=======
